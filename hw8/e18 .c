/*
 * e18.c
 *  растность прежде всего
 * ¬ диапазоне натуральных чисел от 2 до N определить, сколько из них кратны любому из чисел в диапазоне от 2 до 9.
 * ƒанные на входе: ќдно целое число N, больше 2 и не больше 10000
 * ƒанные на выходе: ¬се числа от 2 до 9 в формате: 2 количество чисел кратных 2 3 количество чисел кратных 3 ...
...
int main(int argc, char **argv)
{
	...
	int n;
	int arr2to9[8] = {2}; // от 2 до 9
	int count_arr [8] = {0};
	for (int i = 1; i < 8; i++)
	{
		arr2to9[i] = arr2to9[i-1]+1;
	}
	printf ("¬ведите одно целое число (от 2 до 10000): \n");
	scanf ("%d", &n);
